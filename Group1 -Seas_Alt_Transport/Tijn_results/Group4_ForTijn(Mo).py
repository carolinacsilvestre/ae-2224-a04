...
plt.title("All emission points, all altitudes")
plt.show()
...
labels = ["Lat 90 - 70", "Lat 70-50", "Lat 50-30", "Lat 30-10", "Lat 10- -10", "Lat -10 - -30","Lat -30- -50","Lat -50- -70","Lat 70-90"]
plt.barh(np.flip(labels), np.flip(New_main_trandmap))
plt.title("1st range (90-80) emission points, all altitudes")
plt.show()
###########
#####first ALT (1,8,15, 22)
...
plt.barh(np.flip(labels), np.flip(New_main_trandmap))
plt.title("2nd range (80 - 70) emission points, all altitudes")
plt.show()
################
...
labels = ["Lat 70 - 50", "Lat 70-50", "Lat 50-30", "Lat 30-10", "Lat 10- -10", "Lat -10 - -30","Lat -30- -50","Lat -50- -70","Lat 70-90"]
plt.barh(np.flip(labels), np.flip(New_main_trandmap))
plt.title("3rd range (70 - 60) emission points, all altitudes")
plt.show()
##################
...
labels = ["Lat 90-70", "Lat 70-50", "Lat 50-30", "Lat 30-10", "Lat 10- -10", "Lat -10 - -30","Lat -30- -50","Lat -50- -70","Lat 70-90"]
plt.barh(np.flip(labels), np.flip(New_main_trandmap))
plt.title("4th range (60 - 50) emission points, all altitudes")
plt.show()
#####################
...
labels = ["Lat 90-70", "Lat 70-50", "Lat 50-30", "Lat 30-10", "Lat 10- -10", "Lat -10 - -30","Lat -30- -50","Lat -50- -70","Lat 70-90"]
plt.barh(np.flip(labels), np.flip(New_main_trandmap))
plt.title("5th range (50 - 40) emission points, all altitudes")
plt.show()
###################
...
labels = ["Lat 90-70", "Lat 70-50", "Lat 50-30", "Lat 30-10", "Lat 10- -10", "Lat -10 - -30","Lat -30- -50","Lat -50- -70","Lat 70-90"]
plt.barh(np.flip(labels), np.flip(New_main_trandmap))
plt.title("6th range (40 - 30) emission points, all altitudes")
plt.show()
###################
...
labels = ["Lat 90-70", "Lat 70-50", "Lat 50-30", "Lat 30-10", "Lat 10- -10", "Lat -10 - -30","Lat -30- -50","Lat -50- -70","Lat 70-90"]
plt.barh(np.flip(labels), np.flip(New_main_trandmap))
plt.title("7th range (30 - 20) emission points, all altitudes")
plt.show()
# =============================================================================
